...
/**
 * @description Doctor register params validation
...
function registerValidation(params) {
    ...
    if (isEmpty(params.registration_number)) {
        error.registration_number = 'Field should not be empty'
    }

    if (isEmpty(params.registration_year)) {
        error.registration_year = 'Password should not be empty'
    }
